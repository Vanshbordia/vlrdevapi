...
export function TypeTable({
  ...
  return (
    <div
      id={id}
      className={cn(
        '@container flex flex-col p-1 bg-fd-card text-fd-card-foreground rounded-lg border my-6 text-sm overflow-hidden',
        className,
      )}
      {...props}
    >
...
function Item({
  ...
  return (
    <Collapsible
      ...
      className={cn(
        'rounded-lg border overflow-hidden scroll-m-20 transition-all',
