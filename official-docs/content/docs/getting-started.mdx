...
Both approaches expose the same six namespaces:
...
| `news` | News listings and full news articles |
...
- **`news(page)`** / **`news.article(article_id)`** - news listings and full articles
