...
| `NotFoundError` | Page or article doesn't exist (out-of-range news page, or unknown article ID — vlr.gg returns a generic page for these, so it is detected from the content) |
