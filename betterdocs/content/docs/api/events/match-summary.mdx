...
<Callout type="info" title="Avoid busy waiting">
If you need periodic updates, use a scheduler in your app instead of `time.sleep` loops. The API is rate-limited and safe to call periodically.
</Callout>
...
event_ids = [2498, 2498, 2498]  # Replace with actual event IDs
...
print(create_progress_bar(2498))
```
