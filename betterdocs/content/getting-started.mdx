...
**Next steps:**
- [API Overview](/api/index) - Explore all modules
- [Matches](/api/matches/index) - Browse matches
- [Search](/api/search/index) - Search functionality
- [Events](/api/events/index) - Event listings
- [Players](/api/players/index) - Player profiles
- [Teams](/api/teams/index) - Team information
- [Series](/api/series/index) - Match details
