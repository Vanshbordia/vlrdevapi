...
class NewsArticle(BaseModel):
    ...
    date: datetime_ | None = Field(default=None, description="Publication date in UTC")
    event_name: str = Field(default="", description="Event the article is associated with")
    event_link: str = Field(default="", description="Relative link to the associated event")
    content: str = Field(default="", description="Full text content of the news article")
    content_md: str = Field(default="", description="Full content of the news article converted to Markdown")
